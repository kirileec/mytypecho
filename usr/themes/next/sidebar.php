    ...
    <div class="sidebar-inner">
      <section class="site-overview sidebar-panel <?php if(!$this->is('post')) echo "sidebar-panel-active";?>">
        <div class="site-author motion-element" itemprop="author" itemscope itemtype="http://schema.org/Person">
          <img class="site-author-image" src="https://cdn.v2ex.co/gravatar/ce04034b3dd2c681c5e440126091673c?s=73&d=retro" itemprop="image"/>
...
<a href="<?php $this->options->adminUrl('write-post.php'); ?>" rel="alternate">
              <i class="menu-item-icon"></i>
              New POST
            </a>
</br>
</br>
<a href="<?php $this->options->logoutUrl(); ?>" rel="alternate">
              <i class="menu-item-icon"></i>
              LogOut
            </a>
           <?php else: ?>
              ...
              <a href="<?php $this->options->adminUrl('login.php'); ?>" rel="alternate">    <i class="menu-item-icon"></i>
              Login
            </a>
            <?php endif; ?>
